...
parser.add_argument('--exp', type=str, default='ddpc_cons_lu105_a2_d2_k20_m5_7_labeled', help='experiment_name')
parser.add_argument('--model', type=str, default='unet', help='model_name')
parser.add_argument('--num_classes', type=int,  default=4, help='output channel of network')
parser.add_argument('--labelnum', type=int, default=7, help='labeled data')
parser.add_argument('--stage_name', type=str, default='train', help='self or pre')
...
def test_single_volume(case, net, test_save_path, FLAGS):
    ...
    for ind in range(image.shape[0]):
        ...
        with torch.no_grad():
            out_main = net(input)
            if len(out_main)>1:
                out_main= (out_main[0] + out_main[1]) / 2
...
def Inference(FLAGS):
    ...
    snapshot_path = "./model/ACDC/{}/{}".format(FLAGS.exp, FLAGS.stage_name)
    test_save_path = "./model/ACDC/{}/{}_predictions/".format(FLAGS.exp, FLAGS.model)
