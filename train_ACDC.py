...
from utils.ddpcl_utils import generate_mask_2D, supervison_loss, count_params
from utils.ddpcl_utils import inconsistent_region, pseudo_align_loss, mix_kl_loss, features_diversity_loss
...
parser.add_argument('--kl_weight', type=float, default=0.2, help='weight of kl_weight loss')
